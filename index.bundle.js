...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/index */ \"./src/modules/add_to_list.js\");\n/* harmony import */ var _modules_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/index */ \"./src/modules/storage.js\");\n/* harmony import */ var _modules_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/index */ \"./src/modules/remove_from_list.js\");\n/* harmony import */ var _modules_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/index */ \"./src/modules/update.js\");\n/* eslint-disable import/extensions */\n\n\n\n// ========== Event Listener to display items ===========\ndocument.addEventListener('DOMContentLoaded', _modules_index__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addListItemsToInterface);\n\n// ========== Event Listener to add item to list ==========\nconst form = document.querySelector('.add-form');\nconst listInput = document.getElementById('add-to-list');\n\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const index = _modules_index__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getItems().length + 1;\n  const item = { description: listInput.value, completed: false, index };\n  _modules_index__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addItemToList(item);\n  _modules_index__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addListItemsToInterface();\n  form.reset();\n});\n\n// ======= Event to remove Item from List ========\nconst listItems = document.querySelector('.list-items');\nlistItems.addEventListener('click', (e) => {\n  if (e.target.classList.contains('fa-trash-can')) {\n    _modules_index__WEBPACK_IMPORTED_MODULE_3__[\"default\"].removeItemFromList(e.target);\n    _modules_index__WEBPACK_IMPORTED_MODULE_3__[\"default\"].changeTaskIndex();\n  }\n});\n\n// ======== Event To Add Edited Description To Store ========\nlistItems.addEventListener('input', (e) => {\n  const items = _modules_index__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getItems();\n  if (e.target.name === 'description') {\n    let itemIndex;\n    items.filter((item, index) => {\n      if (item.index === parseInt(e.target.id, 10)) {\n        itemIndex = index;\n        return item.index === parseInt(e.target.id, 10);\n      }\n      return null;\n    });\n    _modules_index__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addEditedTaskToStore(e.target.value, itemIndex);\n  }\n});\n\n// ========= Event to toggle task completion ===========\nlistItems.addEventListener('change', (event) => {\n  if (event.target.name === 'checkbox') {\n    if (event.target.checked) {\n      event.target.nextElementSibling.classList.add('line-through');\n      _modules_index__WEBPACK_IMPORTED_MODULE_4__[\"default\"].updateTaskToCompleted(event.target);\n    } else {\n      event.target.nextElementSibling.classList.remove('line-through');\n      _modules_index__WEBPACK_IMPORTED_MODULE_4__[\"default\"].updateTaskToCompleted(event.target);\n    }\n  }\n});\n\n// ============ Event To Clear All Completed Tasks ============\nconst clearBtn = document.querySelector('.clear-btn');\nclearBtn.addEventListener('click', () => {\n  const tasks = _modules_index__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getItems();\n  const filteredTasks = tasks.filter((task) => task.completed === false);\n  _modules_index__WEBPACK_IMPORTED_MODULE_2__[\"default\"].setItems(filteredTasks);\n  _modules_index__WEBPACK_IMPORTED_MODULE_3__[\"default\"].changeTaskIndex();\n  _modules_index__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addListItemsToInterface();\n});\n\n//# sourceURL=webpack://todoList-app/./src/index.js?");
